...
# Form implementation generated from reading ui file 'mainwind_admin.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.removeUserButton = QtWidgets.QPushButton(self.centralwidget)
        self.removeUserButton.setGeometry(QtCore.QRect(340, 130, 321, 28))
        font = QtGui.QFont()
        font.setFamily("Open Sans SemiBold")
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.removeUserButton.setFont(font)
        self.removeUserButton.setObjectName("removeUserButton")
        self.addUserButton = QtWidgets.QPushButton(self.centralwidget)
        self.addUserButton.setGeometry(QtCore.QRect(10, 130, 321, 28))
        font = QtGui.QFont()
        font.setFamily("Open Sans SemiBold")
        font.setPointSize(10)
        font.setBold(True)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.removeUserButton.setText(_translate("MainWindow", "Удалить пользователя"))
